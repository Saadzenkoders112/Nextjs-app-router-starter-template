      ...
      <div className='p-4 border border-slate-300 rounded-lg bg-white xl:col-span-2 col-span-3'>
        ...
        >
          <AccordionItem value='item-1'>
            <AccordionTrigger>How do i signup for Evntide?</AccordionTrigger>
            <AccordionContent>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Assumenda quidem, consequatur nesciunt voluptatem eligendi nisi
              maiores repellat! Laborum, a eaque.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value='item-2'>
            ...
            <AccordionContent>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Repellat, odit? Veniam, voluptatum. Nobis molestiae tenetur nam
              velit earum libero ratione?
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value='item-3'>
            ...
            <AccordionContent>
              ...
              dolore earum rerum qui impedit repellat perspiciatis iste veniam
              in fugiat.
            </AccordionContent>
          </AccordionItem>
